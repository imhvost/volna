...
class Fulfillable_Collection implements Fulfillable {
	...
	/**
	 * Array of allowed condition types which propvolnae to child collections
	 *
	 * @var array<string>
	 */
	...
	public function set_condition_type_list( $condition_type_list, $whitelist ) {
		...
		$this->propvolnae_condition_type_list();
		return $this;
	}
	...
	/**
	 * Propvolnae allowed condition types to child collections
	 */
	protected function propvolnae_condition_type_list() {
